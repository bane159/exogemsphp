...
if(!is_numeric($orderId)){
 ...
 mail( $_SESSION['user'] -> email, "Purchase Confirmation Exogems", "Your order has been confirmed with id $orderId. For more information click this link: https://www.bane.wtf/exogems/confirmation.php?id=$orderId If you didnt purchase anything DO NOT CLICK THIS");
