    ...
    try {
        ...
        if($errors == 0){
            ...
            if(mailExists($email)){
                ...
                if($res){ 
                    $user = getLatestUser();
                    mail( $user -> email, "Activation Email Exogems", "To confirm your email click this link: https://exogemsphp.branislav.dev/activateViaEmail.php?id=" . $user->id  . "&key=". $user -> activation_key ." If you didnt register  DO NOT CLICK THIS");
